...
![AppVersion: v1.0.1](https://img.shields.io/static/v1?label=AppVersion&message=v1.0.1&color=success)
![Helm: v3](https://img.shields.io/static/v1?label=Helm&message=v3&color=informational&logo=helm)

* [prometheus-pingmesh-exporter] Add ipv4/ipv6 dual stack (#3493)

### Default value changes

```diff
diff --git a/charts/prometheus-pingmesh-exporter/values.yaml b/charts/prometheus-pingmesh-exporter/values.yaml
index dc74e316..8d266cb4 100644
...
![AppVersion: v1.0.0](https://img.shields.io/static/v1?label=AppVersion&message=v1.0.0&color=success)
![Helm: v3](https://img.shields.io/static/v1?label=Helm&message=v3&color=informational&logo=helm)

* [prometheus-pingmesh-exporter] Add Prometheus Pingmesh Exporter (#3327)
